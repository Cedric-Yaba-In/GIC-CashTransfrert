...
export async function POST(request: NextRequest) {
  try {
    ...
    const paymentData = {
      ...
      customer_name: transaction.senderFirstName || '',
      customer_surname: transaction.senderLastName || '',
      customer_email: transaction.senderEmail || '',
      customer_phone_number: transaction.senderPhone || '',
      customer_address: transaction.senderAddress || '',
      customer_city: transaction.senderCity || '',
      customer_country: transaction.senderCountry.code,
      customer_state: transaction.senderRegion || '',
      customer_zip_code: transaction.senderZipCode || '',
