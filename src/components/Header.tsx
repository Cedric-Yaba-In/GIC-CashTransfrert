          ...
          <Link href="/" className="flex items-center space-x-2 sm:space-x-3 group">
            <div className="relative">
              <Image 
                ...
                width={32} 
                height={32}
                className="sm:w-10 sm:h-10 transition-transform group-hover:scale-110"
              />
              {isScrolled && (
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-xl font-bold text-gray-900 group-hover:text-primary-600 transition-colors truncate">
                GIC CashTransfer
              </h1>
              <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">GIC Promote LTD</p>
            </div>
          </Link>
        ...
        <div className={`lg:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="py-3 border-t border-gray-200/50">
            <nav className="space-y-1">
              ...
              <Link 
                href="/track"
                className="block px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-primary-600 transition-colors"
            ...
            <div className="mt-3 pt-3 border-t border-gray-200/50 pb-2">
              <Link 
                href="/transfer"
                className="block w-full btn-primary text-center py-3 text-sm font-semibold"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Envoyer de l'argent
              </Link>
